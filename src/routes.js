...
// TOU Component
const MainAboutChurch = React.lazy(() =>
  import("./views/TOUviews/Main_AboutChurch")
);
const MainMembersData = React.lazy(() =>
  import("./views/TOUviews/Main_MembersData")
);
const MainStructuralOrg = React.lazy(() =>
  import("./views/TOUviews/Main_StructuralOrg")
);
...
const routes = [
  ...
  // Main
  {
    ...
    exact: true,
    name: "Tentang Gereja",
    component: MainAboutChurch
  },
  {
    path: "/members_data",
    exact: true,
    name: "Data Anggota",
    component: MainMembersData
  },
  {
    path: "/structural_org",
    exact: true,
    name: "Struktur Organisasi",
    component: MainStructuralOrg
  },
  {
    path: "/billing",
    exact: true,
  ...
  },
  {
    ...
    exact: true,
    name: "Warta Preview",
    component: WartaPreview
  },
  {
    path: "/warta/archive",
    exact: true,
    name: "Warta Archive",
    component: WartaArchive
  },
  /////////////////
  // Tatacara
  {
